...
const PERKS = [
  {
    id: "p1",
    name: "10% Food Discount",
    cost: 50,
    icon: "🍔",
    desc: "Valid at any ZeroQueue stall today",
  },
  {
    id: "p2",
    name: "Free Drink",
    cost: 100,
    icon: "🥤",
    desc: "Cola, Water or Energy Drink",
  },
  {
    id: "p3",
    name: "Priority Entry",
    cost: 200,
    icon: "⚡",
    desc: "Skip the gate queue next match",
  },
  {
    id: "p4",
    ...
    cost: 500,
    icon: "✨",
    desc: "Premium area for the rest of today",
  },
];
...
const CHALLENGES = [
  ...
  {
    id: "c2",
    desc: "Order from ZeroQueue during halftime",
    reward: 25,
    icon: "🍕",
  },
  {
    id: "c3",
    desc: "Help reduce congestion in 2 zones",
    reward: 40,
    icon: "🚶",
  },
...
export default function RewardsPage({ points = 0, recentActivity = [] }) {
  ...
  const todaysEarnings = recentActivity.reduce(
    (s, a) => s + (a.points || 0),
    0,
  );
  const routeCount = recentActivity.filter((a) =>
    a.action?.toLowerCase().includes("route"),
  ).length;
  const orderCount = recentActivity.filter((a) =>
  ...
  return (
    <div>
      ...
      <div className="section-desc">
        Every smart move earns you points — routes, orders, and behaviour all
        count
      </div>
          ...
          >
            <div>
              ...
              <div
                ...
                style={{ fontSize: 48, color: tier.color }}
              >
                {points}
              </div>
              <div
        ...
        <div className="card">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              ...
              <span
                style={{ fontSize: 16, fontWeight: 700, color: "var(--green)" }}
              >
                {orderCount}
              </span>
            </div>
            ...
            >
              ...
              <span
                style={{ fontSize: 16, fontWeight: 700, color: tier.color }}
              >
                {todaysEarnings}
              </span>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {recommendations.map((rec) => (
              <div
                ...
                onClick={() =>
                  navigate(
                    rec.type === "routing" ? "/app/navigate" : "/app/order",
                  )
                }
              >
                <div style={{ flex: 1 }}>
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  Follow the crowd-avoiding path to earn bonus points
                </div>
              </div>
              ...
              {recentActivity
                ...
                .map((a, i) => (
                  <tr key={`${a.time}-${i}`}>
                    ...
                    <td>
                      <span className="points-chip">+{a.points}</span>
                    </td>
