...
export default function AlertsPage({ simData }) {
  ...
  const staffSuggestions = Object.entries(density)
    ...
    .map(([id, d]) => ({
      ...
      action:
        d > 0.8
          ? "Deploy crowd control immediately"
          : "Send 2 stewards to manage flow",
  ...
  return (
    <div>
      ...
      <div className="section-desc">
        Real-time AI-generated alerts and staff dispatch
      </div>
      ...
      <div className="grid-3 mb-4">
        ...
        <div className="metric-card">
          ...
          <div className="metric-change" style={{ color: "#C27803" }}>
            Monitor closely
          </div>
        </div>
        <div className="metric-card">
        ...
        <div className="card">
          <div className="card-header">
            ...
            <div className="card-subtitle">
              Actions POST to backend → broadcast to all dashboards
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`badge badge-${s.urgency === "critical" ? "red" : "yellow"}`}
                      >
                        {s.urgency}
                      </span>
                    </div>
