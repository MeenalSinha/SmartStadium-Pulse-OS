    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div className="section-desc">
          Pulse OS — your behavioral AI stadium companion
        </div>
      </div>
          ...
          <div style={{ flex: 1 }}>
            ...
            {quietZones.length > 0 && (
              <div style={{ fontSize: 11, color: cfg.color, marginTop: 4 }}>
                {quietZones.length} quiet zone{quietZones.length > 1 ? "s" : ""}{" "}
                available → move now for bonus points
              </div>
            )}
          </div>
          {(crowdStatus.level === "high" ||
            crowdStatus.level === "critical") && (
            <button
      ...
      <div className="grid-3 mb-4">
        {[
          ...
          },
          {
            ...
            desc:
              points > 0
                ? `${points} pts earned this session`
                : "Earn points for smart moves",
            path: "/app/rewards",
            accent: "var(--yellow)",
            glow: "",
          },
