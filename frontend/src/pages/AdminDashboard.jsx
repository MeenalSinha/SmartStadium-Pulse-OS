...
export default function AdminDashboard({ simData, mode, onModeChange }) {
      ...
      setHistory((prev) =>
        [
          ...prev,
          {
            ...
            baseline: Math.round(
              { normal: 25, pre_match: 65, halftime: 85, exit_rush: 90 }[
                mode
              ] ?? 50,
            ),
          },
  ...
  const criticalCount = zoneEntries.filter(
    (z) => z.level === "critical",
  ).length;
    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div className="section-desc">
          Behavioral AI actively redistributing crowd flow — real-time
        </div>
      </div>
      ...
      {aiInsights && (
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, rgba(139,92,246,0.1) 0%, rgba(9,14,26,1) 100%)",
          }}
        >
          <div className="card-header" style={{ marginBottom: 12 }}>
            <div>
              ...
              >
                <span style={{ fontSize: 18 }}>✨</span> Deep Operations Insight
                (Vertex AI)
              </div>
              <div className="card-subtitle">
                Powered by Google Cloud Gemini 2.5 Flash •{" "}
                {aiInsights.cached ? "Cached Response" : "Live GenAI Inference"}
              </div>
            </div>
            <span
              className="badge"
          ...
          >
            ...
            <div style={{ fontWeight: 600, marginBottom: 8, color: "#A78BFA" }}>
              Recommended Actions:
            </div>
      ...
      <div className="card glow-blue mb-4">
        <div className="card-header">
          <div>
            ...
            <div className="card-subtitle">
              Trigger crowd events — watch AI respond in real time
            </div>
          </div>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <div
              style={{
                ...
                border: `1px solid ${MODE_COLORS[mode]}55`,
        ...
        <div className="sim-modes">
          {[
            ...
            {
              key: "pre_match",
              label: "🟡 Pre-Match Rush",
              sub: "Gates open, 65% fill",
            },
            {
              key: "halftime",
              label: "🔴 Half-Time Surge",
              sub: "Critical — 85% fill",
            },
            {
              key: "exit_rush",
              label: "🟣 Exit Rush",
            ...
            <button
              key={m.key}
              className={`sim-mode-btn${mode === m.key ? " active" : ""}`}
          ...
          {[
            {
              ...
              value: `${metrics.congestionReduced}%`,
              color: "var(--green)",
        ...
        <div className="card">
          <div className="card-header">
            <div>
              ...
              <div className="card-subtitle">
                Real-time zone density — {zoneEntries.length} zones monitored
              </div>
            </div>
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <div className="card">
          <div className="card-header">
            <div>
              ...
              <div className="card-subtitle">
                Coloured markers = scenario changes
              </div>
            </div>
          </div>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <div className="card-subtitle">
            Live stall wait times — AI routing fans to shortest queues
          </div>
        </div>
        {stallData.length === 0 ? (
