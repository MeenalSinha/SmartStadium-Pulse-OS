  ...
  const handleSmartRoute = useCallback(async () => {
    ...
    try {
      ...
      if (result.pointsEarned && onPointsEarned) {
        onPointsEarned(
          result.pointsEarned,
          `Smart reroute to ${result.toName}`,
        );
      }
    } catch (e) {
  ...
  return (
    <div>
      ...
      <div className="section-desc">
        AI-powered crowd-avoiding route planner
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div className="card">
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              {currentDensity > 0 && (
                ...
                >
                  <div
                    className={`density-dot ${getDensityLevel(currentDensity)}`}
                  />
                  <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
                    Your zone is <strong>{pct(currentDensity)}% full</strong>
                    {currentDensity > 0.6
                      ? " — crowded, rerouting recommended"
                      : currentDensity > 0.35
                        ? " — moderate"
                        : " — comfortable"}
                  </span>
          ...
          {route && (
            <div
              ...
              style={{
                borderColor:
                  route.pointsEarned === 15 ? "var(--green)" : "var(--border)",
              }}
            >
              <div
                style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {route.path.map((step, i) => (
                  ...
                  >
                    ...
                    <div
                      style={{
                        paddingBottom: i < route.path.length - 1 ? 22 : 0,
                      }}
                    >
                      <div
                        style={{
                      ...
                      <div
                        className={`badge badge-${getDensityLevel(step.density) === "critical" ? "red" : getDensityLevel(step.density) === "high" ? "orange" : getDensityLevel(step.density) === "moderate" ? "yellow" : "green"}`}
                        style={{ fontSize: 10 }}
                      >
